class Nanny < Formula
    ...
    url "https://github.com/kolenkainc/Nanny/releases/download/1.0.0.145/nanny_1.0.0.145.tar.gz"
    sha256 "9d9a1240f1fa08b194d5e45db2ce9ff75ca945747459a3600db63ee95fdc26fe"
    license "MIT"
